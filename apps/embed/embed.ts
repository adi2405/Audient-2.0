...
(function () {
  ...
  if (!organizationId) {
    console.error("Audient Widget: data-organization-id attribute is required");
    return;
  }
  ...
  function render() {
    ...
    button.id = "audient-widget-button";
    ...
    button.addEventListener("mouseenter", () => {
      if (button)
        button.style.boxShadow = "0 4px 24px rgba(59, 130, 246, 0.35)";
    });
    button.addEventListener("mouseleave", () => {
      if (button) button.style.boxShadow = "none";
    });
    ...
    container.id = "audient-widget-container";
